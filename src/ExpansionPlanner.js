...
const Builder = require('role.Builder').Builder;
const Claimer = require('role.Claimer').Claimer;
const Controllers = require('Controllers');
const Defender = require('role.Defender').Defender;
const Miner = require('role.Miner').Miner;
const Mission = require('Mission');
const Mule = require('role.Mule').Mule;
const Profiler = require('Profiler');
const Reloader = require('role.Reloader').Reloader;
const Repairer = require('role.Repairer').Repairer;
const Rooms = require('Rooms');
const Sources = require('Sources');
const Upgrader = require('role.Upgrader').Upgrader;
