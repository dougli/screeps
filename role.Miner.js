...
var Miner = {
    constructContainerFor: function(source) {
        var spaces = [];
    ...
    run: function(creep) {
        ...
        if (!container) {
            ...
            if (!site) {
                sourceMemory.containerSite = Miner.constructContainerFor(source);
            }
        }
        ...
        } else if (!creep.carry.energy || creep.carry.energy < creep.carryCapacity - Miner.getMineAmount(creep)) {
