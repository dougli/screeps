...
const SIZE = 13;
const BASE_LAYOUT = [
/*  1 */  [null, null, null, null, s(STRUCTURE_EXTENSION, 8), null, null, null, s(STRUCTURE_EXTENSION, 8)],
/*  2 */  [null, s(STRUCTURE_OBSERVER, 8), s(STRUCTURE_LAB, 8), s(STRUCTURE_LAB, 8), s(STRUCTURE_ROAD, 6), s(STRUCTURE_EXTENSION, 8), s(STRUCTURE_EXTENSION, 8), s(STRUCTURE_EXTENSION, 8), s(STRUCTURE_ROAD, 7), s(STRUCTURE_EXTENSION, 8), s(STRUCTURE_EXTENSION, 8)],
/*  3 */  [null, s(STRUCTURE_LAB, 8), s(STRUCTURE_LAB, 7), s(STRUCTURE_ROAD, 6), s(STRUCTURE_LAB, 7), s(STRUCTURE_ROAD, 6), s(STRUCTURE_EXTENSION, 7), s(STRUCTURE_ROAD, 7), s(STRUCTURE_EXTENSION, 7), s(STRUCTURE_ROAD, 7), s(STRUCTURE_EXTENSION, 8), s(STRUCTURE_EXTENSION, 8)],
/*  4 */  [null, s(STRUCTURE_LAB, 8), s(STRUCTURE_ROAD, 6), s(STRUCTURE_LAB, 6), s(STRUCTURE_LAB, 6), s(STRUCTURE_EXTENSION, 6), s(STRUCTURE_ROAD, 6), s(STRUCTURE_EXTENSION, 7), s(STRUCTURE_EXTENSION, 7), s(STRUCTURE_EXTENSION, 7), s(STRUCTURE_ROAD, 7), s(STRUCTURE_EXTENSION, 8)],
...
/*  6 */  [null, s(STRUCTURE_EXTENSION, 6), s(STRUCTURE_ROAD, 6), s(STRUCTURE_TOWER, 8), s(STRUCTURE_ROAD, 5), null, s(STRUCTURE_ROAD, 4), s(STRUCTURE_NUKER, 8), s(STRUCTURE_ROAD, 7), s(STRUCTURE_EXTENSION, 6), s(STRUCTURE_ROAD, 7), s(STRUCTURE_EXTENSION, 7)],
/*  7 */  [null, s(STRUCTURE_EXTENSION, 3), s(STRUCTURE_EXTENSION, 3), s(STRUCTURE_ROAD, 3), s(STRUCTURE_LINK, 5), s(STRUCTURE_ROAD, 3), s(STRUCTURE_STORAGE, 4), s(STRUCTURE_ROAD, 4), s(STRUCTURE_TOWER, 8), s(STRUCTURE_ROAD, 5), s(STRUCTURE_EXTENSION, 6), s(STRUCTURE_EXTENSION, 6)],
